...
func (x *SignUpResponse) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
var file_pkg_proto_auth_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x5d, 0x0a, 0x0d,
	...
	0x77, 0x6f, 0x72, 0x64, 0x22, 0x27, 0x0a, 0x0f, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65,
	...
	0x79, 0x22, 0x54, 0x0a, 0x0e, 0x53, 0x69, 0x67, 0x6e, 0x49, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x40, 0x0a, 0x10, 0x56, 0x61, 0x6c, 0x69, 0x64,
	...
	0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xb2, 0x01, 0x0a, 0x0b, 0x41, 0x75,
	...
	0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x10,
...
var file_pkg_proto_auth_proto_depIdxs = []int32{
	...
	4, // 4: auth.AuthService.SignIn:output_type -> auth.SignInResponse
...
func file_pkg_proto_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_proto_auth_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pkg_proto_auth_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pkg_proto_auth_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_pkg_proto_auth_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_pkg_proto_auth_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_pkg_proto_auth_proto_msgTypes[5].Exporter = func(v any, i int) any {
